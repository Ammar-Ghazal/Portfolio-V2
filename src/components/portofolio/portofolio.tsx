...
export const Portofolio = ({ className }: PortofolioProps) => {
    return (
        <div className={classNames(styles.root, className)}>
            ...
            <p className={styles.p}>I am a software developer with experience in {' '}
                <span className={styles.span}>C++, C, Java, Python, mySQL, TypeScript, JavaScript, HTML </span>
                {'and '}
                <span className={styles.span}>CSS</span>. I am a curious and motivated learner who is always looking to explore and learn about new technology.</p>
            ...
            <div className={styles.socials}>
                <a href="https://www.linkedin.com/in/ammar-ghazal-2269b61ab/">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                ...
                <a href="https://github.com/Ammar-Ghazal">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        className={styles['social-svg']}
